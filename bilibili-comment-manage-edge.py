...
if __name__ == "__main__":
    ...
    # options.add_argument('--user-data-dir=C:\\Users\\用户名\\AppData\\Local\\Microsoft\\Edge\\User Data\\Profile 1') # 替换为实际路径

    # 定义 EdgeDriver 的路径
    service = Service(executable_path="C:\\Users\\用户名\\Desktop\\msedgedriver.exe") # 替换为 msedgedriver 的实际路径
